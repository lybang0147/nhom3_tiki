...
import com.hcmute.starter.handler.FileNotSupportedException;
...
public class ImageStorageServiceImpl implements ImageStorageService {
    ...
    public String  saveProductRatingImg(MultipartFile file, String fileName) {
        Map r;
        try {
            r = this.cloudinary().uploader().upload(file.getBytes(), ObjectUtils.asMap("resource_type","auto","upload_preset","bang","public_id","tiki_product_rating/"+fileName));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        return (String) r.get("secure_url");
    ...
    @Override
    public List<String> saveProductRatingList(MultipartFile[] files, int id) throws RuntimeException{
